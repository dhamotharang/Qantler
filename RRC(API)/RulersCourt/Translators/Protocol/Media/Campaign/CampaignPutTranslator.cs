...
{
    public static class CampaignPutTranslator
    {
        public static CampaignPutModel TranslateAsDesignPatch(this SqlDataReader reader, bool isList = false)
        {
            if (!isList)
            {
                if (!reader.HasRows)
            ...
            var campaignModel = new CampaignPutModel();
        ...
        public static List<CampaignPutModel> TranslateAsCampaignPatchList(this SqlDataReader reader)
        {
            var babyAdditionList = new List<CampaignPutModel>();
            while (reader.Read())
            {
