...
{
    public static class LetterOutboundHistoryLogTranslator
    {
        public static LetterOutboundHistoryLogModel TranslateAsLetterOutboundHistoryLog(this SqlDataReader reader, bool isList = false)
        {
            if (!isList)
            {
                if (!reader.HasRows)
            ...
            var letterHistoryLogModel = new LetterOutboundHistoryLogModel();
        ...
        public static List<LetterOutboundHistoryLogModel> TranslateAsLetterOutboundHistoryLogList(this SqlDataReader reader)
        {
            var letterHistoryLogList = new List<LetterOutboundHistoryLogModel>();
            while (reader.Read())
            {
                letterHistoryLogList.Add(TranslateAsLetterOutboundHistoryLog(reader, true));
            }
