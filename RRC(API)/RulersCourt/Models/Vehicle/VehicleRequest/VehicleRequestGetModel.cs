...
{
    [DataContract]
    public class VehicleRequestGetModel
    {
        ...
        [DataMember(Name = "M_CoPassengarList")]
        public List<OrganizationModel> M_CoPassengarList { get; set; }

        [DataMember(Name = "M_TripOnSameDay")]
        public List<TripSameDayPeriodModel> M_TripOnSameDay { get; set; }
