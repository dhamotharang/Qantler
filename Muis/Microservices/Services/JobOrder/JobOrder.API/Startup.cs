...
using Dapper;
using JobOrder.API.EventHandlers;
...
namespace JobOrder.API
{
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddTransient<IJobOrderService, JobOrderService>()
        .AddTransient<IFindingsService, FindingsService>()
    ...
    void RegisterEventBus(IServiceCollection services)
    {
      ...
      services.AddTransient<OnIdentityChangedEventHandler>()
        .AddTransient<OnCertificateIssuedEventHandler>();
    }
    ...
    void ConfigureEventBus(IApplicationBuilder app)
    {
      ...
      eventBus.Subscribe<OnCertificateIssuedEvent, OnCertificateIssuedEventHandler>();
