...
{
  public class HC03ApprovalProcessCommand
  {
    ...
    public HC03ApprovalProcessCommand(Model.Request requestBasic, Review review, 
    ...
    public async Task Invoke()
    {
      ...
      await new HC03RenewalSyncSubCommand(
        _review,
        _dbContext,
        new Officer(_review.ReviewerID.Value, _review.ReviewerName))
        .Invoke();
    ...
    void PostCommit(RequestDataHolder holder)
    {
      ...
      // no need for this. assumed it will always have stage2
      ...
      Officer officer)
    {
      ...
      foreach (var item in approvedLineItems)
      {
        ...
        await new HC03Certificate360Strategy(_dbContext, _requestBasic, _certificate, officer)
            .Invoke();
