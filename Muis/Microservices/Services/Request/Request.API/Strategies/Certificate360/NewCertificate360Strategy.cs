...
{
  public class NewCertificate360Strategy : IStrategy<Model.Certificate360>
  {
    ...
    public NewCertificate360Strategy(DbContext dbContext, Model.Request request,
    ...
    public async Task<Model.Certificate360> Invoke()
    {
      ...
      // Probably from old data. Applicable to renewal.
