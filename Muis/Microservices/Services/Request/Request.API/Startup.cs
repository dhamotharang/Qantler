...
using Request.API.EventHandlers;
using Request.API.Middleware;
...
namespace Request.API
{
  public class Startup
  {
    ...
    void RegisterEventBus(IServiceCollection services)
    {
      ...
      services.AddTransient<OnBillGeneratedEventHandler>()
        .AddTransient<OnBillPaidEventHandler>()
        .AddTransient<OnIdentityChangedEventHandler>()
        .AddTransient<OnJobOrderStatusChangedEventHandler>();
    }

    void ConfigureEventBus(IApplicationBuilder app)
    {
      var eventBus = app.ApplicationServices.GetRequiredService<IEventBus>();
      eventBus.Subscribe<OnBillGeneratedEvent, OnBillGeneratedEventHandler>();
      eventBus.Subscribe<OnBillPaidEvent, OnBillPaidEventHandler>();
