...
{
  public class AppealDecisionWarningSubCommand : SubCommand
  {
    ...
    public AppealDecisionWarningSubCommand(DbContext dbContext, long caseID,
    ...
    public override async Task Execute()
    {
      ...
      var activityID = await _dbContext.Activity.InsertActivity(new Activity
      {
        ...
        Notes = string.Format(
          await _dbContext.Translation.GetTranslation(Locale.EN, "AppealWarningNote"),
          _param.Notes),
        User = _user
      }, _caseID);
