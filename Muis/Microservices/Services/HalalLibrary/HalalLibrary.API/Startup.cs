...
using Dapper;
using HalalLibrary.API.EventHandlers;
using HalalLibrary.API.Services;
using HalalLibrary.Events;
using HalalLibrary.Service;
...
namespace HalalLibrary.API
{
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      .AddTransient<ICertifyingBodyService, CertifyingBodyService>()
    ...
    void RegisterEventBus(IServiceCollection services)
    {
      ...
      services.AddTransient<NewIngredientEventHandler>();
    ...
    void ConfigureEventBus(IApplicationBuilder app)
    {
      ...
      eventBus.Subscribe<NewIngredientEvent, NewIngredientEventHandler>();
