...
using Identity.API.EventHandlers;
  ...
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddSingleton<ICacheProvider, CacheProvider>()
        .AddSingleton<ISmtpProvider, SmtpProvider>();
    ...
    void RegisterEventBus(IServiceCollection services)
    {
      ...
      services.AddSingleton<SendNotificationWithPermissionsEventHandler>();
    ...
    void ConfigureEventBus(IApplicationBuilder app)
    {
      ...
      eventBus.Subscribe<SendNotificationWithPermissionsEvent,
        SendNotificationWithPermissionsEventHandler>();
