		...
		public async Task<DatabaseResponse> CreateMaterialType(CreateMaterialTypeMaster materialType)
		{
			try
			{
				...
				SqlParameter[] parameters =
			   {
				...
				parameters[1].Value = materialType.Name_Ar;
				parameters[2].Value = materialType.CreatedBy;
				parameters[3].Value = materialType.Weight;
		...
		public async Task<DatabaseResponse> UpdateMaterialType(UpdateMaterialTypeMaster materialType, int id)
		{
			try
			{
				...
				SqlParameter[] parameters =
			   {
				...
				parameters[2].Value = materialType.Name_Ar;
				parameters[3].Value = materialType.UpdatedBy;
				parameters[4].Value = materialType.Active;
				parameters[5].Value = materialType.Weight;
