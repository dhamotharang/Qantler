        ...
        public async Task<DatabaseResponse> CreateStream(CreateStreamMaster stream)
        {
            try
            {
                ...
                SqlParameter[] parameters =
               {
                ...
                parameters[1].Value = stream.Name_Ar;
                parameters[2].Value = stream.CreatedBy;
        ...
        public async Task<DatabaseResponse> UpdateStream(UpdateStreamMaster stream, int id)
        {
            try
            {
                ...
                SqlParameter[] parameters =
               {
                ...
                parameters[2].Value = stream.Name_Ar;
                parameters[3].Value = stream.UpdatedBy;
                parameters[4].Value = stream.Active;
