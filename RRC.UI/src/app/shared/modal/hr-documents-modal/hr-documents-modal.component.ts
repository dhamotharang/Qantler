...
@Component({
  selector: 'app-hr-documents-modal',
  templateUrl: './hr-documents-modal.component.html',
  styleUrls: ['./hr-documents-modal.component.scss']
})
export class HrDocumentsModalComponent implements OnInit {
  user = {
    id: 0
  };
