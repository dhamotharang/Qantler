...
@Component({
  selector: 'app-media-press-release-edit',
  templateUrl: './media-press-release-edit.component.html',
  styleUrls: ['./media-press-release-edit.component.scss']
})
export class MediaPressReleaseEditComponent implements OnInit {
  lang: any;
  screenStatus: any;
