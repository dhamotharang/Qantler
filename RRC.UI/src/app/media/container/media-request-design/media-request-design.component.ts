...
@Component({
  selector: 'app-media-request-design',
  templateUrl: './media-request-design.component.html',
  styleUrls: ['./media-request-design.component.scss']
})
export class MediaRequestDesignComponent implements OnInit {
