...
@Component({
  selector: 'app-photographer-request-edit',
  templateUrl: './photographer-request-edit.component.html',
  styleUrls: ['./photographer-request-edit.component.scss']
})
export class PhotographerRequestEditComponent implements OnInit {
  lang: any;
  screenStatus: any;
