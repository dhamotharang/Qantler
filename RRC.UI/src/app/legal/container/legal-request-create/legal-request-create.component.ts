...
@Component({
  selector: 'app-legal-request-create',
  templateUrl: './legal-request-create.component.html',
  styleUrls: ['./legal-request-create.component.scss']
})
export class LegalRequestCreateComponent implements OnInit {
  lang: any;
  screenStatus: any;
