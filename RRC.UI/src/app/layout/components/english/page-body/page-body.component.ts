...
export class PageBodyComponent implements OnInit {
  ...
  filterCalendarEvent() {
    console.log(this.searchForm.value.smartSearch, 'you just clicked enter');
  ...
  createForm() {
    if (this.btn_url == 'citizen-affair-create') {
      ...
      var data = [
        { 'name': 'Citizen Affair', 'img': 'assets/citizen-affair/citizen-affair.png', 'url': 'citizen-affair-create', 'pagename': 'citizen-affair', 'lang': 'en' },
        { 'name': 'Complaints/Suggestion', 'img': 'assets/citizen-affair/complaints.png', 'url': 'complaint-suggestion', 'pagename': 'citizen-affair', 'lang': 'en' }
      ];
    ...
    if (this.btn_url == 'media-request-list') {
      ...
      var data = [
        ...
        { 'name': 'Request For Photographer', 'img': 'assets/media/photo-camera.png', 'url': 'photographer/create', 'pagename': 'media', 'lang': 'en' },
